...
export interface StatusData {
  ...
  /** a hét napjainak sávja: a négy hét megakadásai a hét hét napjára osztva (0 = vasárnap) — a csúcs-nap ebből áll */
  ...
  focusStreak?: number;
  /** A LEGHOSSZABB SOROZAT a naplóban — a kártya és a réteg a mostani sorozat mellett, zárójelben mondja. */
...
export interface UsageStatsData {
  ...
  focusStreak?: number;
  /** a leghosszabb menet-sorozat a naplóban (nap) — a mostani mércéje; 0, ha nincs */
  focusLongestStreak?: number;
