...
import { focusByHour, focusByWeekday, focusDayStreak, focusLongestStreak, packCoveringHour, peakFocusHour, peakWindowPick, summarizeFocus, summarizeFocusPrevWeek } from '../shared/focus';
...
export function digestTextNow(state: HelperState, now: number): string | null {
  ...
  return digestText({
    ...
    // A leghosszabb sorozat: a mondat a mostani mellett, zárójelben mondja, ha több.
