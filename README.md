...
- **Aktív idő mérése és statisztikák**: melyik oldalon és appban mennyit töltesz —
  ...
  **megakadások**: a gépen hányszor vitt a tiltó lapra a böngésző-bővítmény
  ...
  hányszor állította meg a szűrő (hosztonként két percen belül egyszer; a
...
- **Hosztnevek oldalanként** (asztali gép; a lista szinkronnal a telefonra is
  ...
  az oldalt kell törölni. A lista **nevenként** szinkronizál: minden felvétel
  és levétel jelet kap (a változat számát), és a nagyobb jel dönt — a
  kifizetett levétel akkor sem jön vissza, ha a másik gép közben mást írt
  ugyanarra az oldalra; jel nélkül (régi kliens) a bővebb lista nyer, tehát
  versenyhelyzet sosem old fel.
...
- **Kulcsszó-szabályok: bármely oldalon, ha a cím tartalmazza** (gép +
  böngésző; a telefonon a hosztnévben tilt). A blokklista egész oldalakat lát, a
  ...
  Őszinte határ: a gépen csak a böngészőben tilt, ahova a bővítmény telepítve
  van; a telefonon a hosztnévben tilt (a rendszer-infrastruktúra és a saját
  fiókkiszolgáló sosem), az útvonalat és a címsort ott nem látja senki. Lásd
...
- **Munkamenetek: „most csak ez mehet”** (gép, Android, iPhone). A blokklista arról szól,
  ...
  **Statisztika a menetekről, minden eszközről:** hányszor ültél le dolgozni és
  ...
  Kettőtől; egy nap nem sorozat, a megszakadt sorozat nem bűn, csak nulla.
